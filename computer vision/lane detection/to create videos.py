...
while cap.isOpened():
    ...
    if success:
        ...
        results = model1.predict(frame, conf=0.1)
###################
...
####################
        ...
        try:
            ...
            resized_frame1 = cv2.resize(annotated_frame, (640, 480))
            cv2.imshow("YOLOv8 Inference2",resized_frame1)
            ...
            try:
                ...
                resized_frame2 = cv2.resize(annotated_frame1, (640, 480))
                cv2.imshow("YOLOv8 Inference2",resized_frame2)
            except:
                print('no object')
                # resized_frame2 = cv2.resize(annotated_frame1, (640, 640))
                cv2.imshow("YOLOv8 Inference2",resized_frame1)
            ...
            cv2.imshow("YOLOv8 Inference2",cv2.resize(frame, (640, 480)))
